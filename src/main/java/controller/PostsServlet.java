...
public class PostsServlet extends HttpServlet {
    ...
    private void filterPost(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        String title = request.getParameter("title");

        request.setAttribute("listPost", postsDAO.filterPosts(title));
        RequestDispatcher dispatcher = request.getRequestDispatcher("fil/filter.jsp");
...
////                    break;
    ...
    private void showFilterForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("fil/filter.jsp");
        dispatcher.forward(request, response);
    }
    private void listPosts(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("userName", listPosts);
    ...
    private void insertContent(HttpServletRequest request, HttpServletResponse response)
        ...
        Posts newUser = new Posts( title, content, timestamp, avatar, shortdescription,  access);
...
//            newUser.setTimestamp(timestamp);
        ...
        List<Posts> newPost = postsDAO.selectAllPosts();
        request.setAttribute("userName", newPost);
