...
public class Posts {
    ...
    public Posts(int id, String title, String content, String timestamp, String avatar, String shortdescription, int numberofcomment, int numberoflike, boolean access) {}
